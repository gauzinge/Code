...
#ifndef EUTelTrackExporter_h
#define EUTelTrackExporter_h 1
...
namespace eutelescope {
  ...
  class EUTelTrackExporter : public marlin::Processor {
  ...
  public:
     ...
     */
    virtual Processor*  newProcessor() { return new EUTelTrackExporter ; }
  ...
  EUTelTrackExporter aEUTelTrackExporter ;
